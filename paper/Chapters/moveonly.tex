...
\begin{itemize}
    ...
    \item $\cc{\texttt{skip}} {P::L}{ r} \to \cc{P}{L}{r}$. This means we have $\sosb{\texttt{skip}}{P::L}{s}$ for any $s$ equivalent to $r$ and we can apply the rule [load$_{\textrm{os}}$]. This gives us $\sosb{\texttt{skip}}{P::L}{s} \Rightarrow \sosb{P}{L}{s}$, which proves this case. 
