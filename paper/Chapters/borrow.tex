...
In this chapter, we will move to the small step semantics right away. These are of similar form to the previous chapter, except that we have rules of the form 
